...
class StockEnv:
    ...
    def LoadData(self, ticker):
        ...
        data = ftse.history(start="2021-01-29", end="2021-02-03", interval = "1m")
        data2 = ftse.history(start="2021-01-22", end="2021-01-29", interval = "1m")
        data3 = ftse.history(start="2021-01-15", end="2021-01-22", interval = "1m")
